...
/* harmony import */ var _post_success_comp_post_success_comp_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./post-success-comp/./post-success-comp.component */ "./src/app/post-success-comp/post-success-comp.component.ts");
...
var routes = [
    ...
    {
        path: "success",
        component: _post_success_comp_post_success_comp_component__WEBPACK_IMPORTED_MODULE_5__["PostSuccessCompComponent"]
    }
];
...
/* harmony import */ var _post_success_comp_post_success_comp_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./post-success-comp/post-success-comp.component */ "./src/app/post-success-comp/post-success-comp.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _post_success_comp_post_success_comp_component__WEBPACK_IMPORTED_MODULE_10__["PostSuccessCompComponent"],
            ],
            imports: [
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.createEvcServcie = function (data) {
        ...
        return this.http.post(url2, body, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Authorization': 'Basic YWRtaW46YWRtaW4=',
                'Content-Type': 'application/json'
            }) });
    };
    DataService.prototype.deleteEvcServcie = function (rawData) {
        ...
        return this.http.delete(url2, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Authorization': 'Basic YWRtaW46YWRtaW4=',
                'Content-Type': 'application/json'
            }) });
    };
...
module.exports = "<nav>\n  <ul>\n      <li>\n          <a routerLink=\"post\">Create Service\n          </a>\n        </li>\n    <li>\n      <a routerLink=\"get\">Get Service\n      </a>\n    </li>\n  </ul>\n</nav>"
...
module.exports = ".wrapper {\n    text-align: center;\n}\n\n.button {\n    position: absolute;\n    top: 50%;\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PostCompComponent = /** @class */ (function () {
    // data :DataService;
    function PostCompComponent(data, router) {
        this.data = data;
        this.router = router;
    }
    ...
    PostCompComponent.prototype.internalcreateEvcService = function () {
        ...
        (this.data.createEvcServcie(rawdata)).subscribe(function (data1) {
    ...
    PostCompComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], PostCompComponent);
...
/***/ "./src/app/post-success-comp/post-success-comp.component.css":
/*!*******************************************************************!*\
  !*** ./src/app/post-success-comp/post-success-comp.component.css ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Bvc3Qtc3VjY2Vzcy1jb21wL3Bvc3Qtc3VjY2Vzcy1jb21wLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/post-success-comp/post-success-comp.component.html":
/*!********************************************************************!*\
  !*** ./src/app/post-success-comp/post-success-comp.component.html ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = "<!----<link href=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">\n<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/js/bootstrap.min.js\"></script>\n<script src=\"//code.jquery.com/jquery-1.11.1.min.js\"></script>\n------ Include the above in your HEAD tag ---------->\n\n<div class=\"container\" style=\"align-content:center;height: 350px;width: 350px\" >\n\t<div class=\"row text-center\">\n        <div class=\"col-sm-6 col-sm-offset-3\">\n        <br><br> <h2 style=\"color:#0fad00;text-align:center\"> Success</h2>\n     <p style=\"font-size:20px;color:#5C5C5C; text-align:center\">Service Created Sucessfully </p><br>\n     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n     <a routerLink=\"/get\" style=\"font-size:20px;color:rgb(31, 43, 211);\">Get</a>\n    <br><br>\n  </div>\n        \n\t</div>\n</div>\n"

/***/ }),

/***/ "./src/app/post-success-comp/post-success-comp.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/post-success-comp/post-success-comp.component.ts ***!
  \******************************************************************/
/*! exports provided: PostSuccessCompComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PostSuccessCompComponent", function() { return PostSuccessCompComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var PostSuccessCompComponent = /** @class */ (function () {
    function PostSuccessCompComponent() {
    }
    PostSuccessCompComponent.prototype.ngOnInit = function () {
    };
    PostSuccessCompComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-post-success-comp',
            template: __webpack_require__(/*! ./post-success-comp.component.html */ "./src/app/post-success-comp/post-success-comp.component.html"),
            styles: [__webpack_require__(/*! ./post-success-comp.component.css */ "./src/app/post-success-comp/post-success-comp.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], PostSuccessCompComponent);
    return PostSuccessCompComponent;
}());
...
module.exports = ".button{\n    padding-left:100cm;\n    margin-left:100cm;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\n<div>\n        <div>\n            <ul>\n                <li *ngFor=\"let d of data1$\">\n\n                    <br />\n                   Evc Id :&nbsp;<b><I>{{d['evc-id']}}</I></b>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n                   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button (click)=\"deleteEvc(d['evc-id'])\">delete</button>\n                    <br />\n                    Service Type : {{d['svc-type'] | uppercase}}\n                    <br />\n                    End Points :\n                    <ol type=\"1\">\n                    <div *ngFor=\"let end of d['end-points']['end-point']\">\n                        <li>\n                        {{end[\"uni-id\"]}}\n                        </li>\n                    </div>\n                </ol>\n                    Vlan Id :<span *ngIf=\"d['svc-type'] === 'evpl' || d['svc-type']==='evplan'\">{{d[\"end-points\"][\"end-point\"][0][\"ce-vlans\"][\"ce-vlan\"]}}</span>\n                    <br/>\n                    <br/>\n                </li>\n\n            </ul>\n        </div>\n    </div>\n"
...
var UserCompComponent = /** @class */ (function () {
    function UserCompComponent(data) {
        ...
        this.data.getUsers().subscribe(function (data) {
            _this.users$ = data;
            _this.result1$ = data['mef-services'];
            _this.result2$ = _this.result1$['carrier-ethernet'];
            _this.result$ = _this.result2$['subscriber-services'];
            _this.data1$ = _this.result$['evc'];
    ...
    UserCompComponent.prototype.deleteEvc = function (evcId) {
        console.log('Delete data for ' + evcId);
        (this.data.deleteEvcServcie(evcId)).subscribe(function (error) { return console.log(error); });
        //  browser.sleep(100);
        location.reload();
    };
