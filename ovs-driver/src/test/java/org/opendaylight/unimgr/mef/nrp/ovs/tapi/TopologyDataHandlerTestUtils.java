...
public class TopologyDataHandlerTestUtils {
    ...
    protected org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.topology.Node readOvsNode() {
        return DataStoreTestUtils.read(getNodeIid(),dataBroker);
    }

    protected List<org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.tapi.context.ServiceInterfacePoint> readSips() {
    ...
    private static InstanceIdentifier getNodeIid() {
        return getTopoIid()
                .child(org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.topology.Node.class,
                        new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.topology.NodeKey(new Uuid(ovsNodeId)));
    }

    private static InstanceIdentifier getTopoIid() {
        return InstanceIdentifier.create(Context.class)
                .augmentation(Context1.class)
                .child(org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.topology.context.Topology.class,
                        new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.topology.context.TopologyKey(new Uuid(prestoNrpTopoId)));
    }
}