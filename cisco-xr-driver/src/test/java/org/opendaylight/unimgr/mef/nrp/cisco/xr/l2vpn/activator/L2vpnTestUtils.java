...
public class L2vpnTestUtils {
	 ...
	 * assertEquals(mtuValue,mtu.getMtu()); assertNotNull(mtu.getOwner()); }
	 * 
	 ...
	 * TpId(port)); }
	 * 
	 * public static void checkDeactivated(DataBroker broker, String
	 * deactivatedPort) { ReadTransaction transaction =
	 ...
	 * 
	 * private static void
	 * checkInterfaceConfigurationDeactivation(FluentFuture<Optional<
	 * InterfaceConfigurations>> driverInterfaceConfigurations, String
	 * deactivatedPort) throws InterruptedException, ExecutionException{ if
