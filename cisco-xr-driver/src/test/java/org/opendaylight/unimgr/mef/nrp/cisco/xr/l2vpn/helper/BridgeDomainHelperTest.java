...
public class BridgeDomainHelperTest {
	...
	public void createBridgeDomainGroupsTest() {
		...
		BridgeDomainGroups bridgeDoaminGroups=BridgeDomainHelper.createBridgeDomainGroups(bridgeDomainGroup);
    ...
    public void appendBridgeDomainTest()
    {
    	...
    	BridgeDomainHelper bridgeDomainHelper1=	bridgeDomainHelper.appendBridgeDomain(name, bdattachmentCircuits, bdpseudowires);
