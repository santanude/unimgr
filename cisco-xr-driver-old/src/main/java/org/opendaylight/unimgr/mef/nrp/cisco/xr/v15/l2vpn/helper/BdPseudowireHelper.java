 ...
 */
package org.opendaylight.unimgr.mef.nrp.cisco.xr.older.l2vpn.helper;
 ...
 */
public class BdPseudowireHelper {

    private List<BdPseudowire> bdpseudowires;

    public BdPseudowireHelper() {
        bdpseudowires = new LinkedList<>();
    }
    
    public BdPseudowireHelper addBdPseudowire(Ipv4AddressNoZone neighbor) {
