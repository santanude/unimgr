...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.ContextBuilder;
...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.topology.context.TopologyBuilder;
...
public class NrpInitializer implements TopologyManager {
    ...
    public void init() throws Exception {
        ...
        if (! context.isPresent()) {
            ...
            Context ctx = new ContextBuilder()
                    ...
                    .addAugmentation(org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.Context1.class, context())
                    .addAugmentation(org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.connectivity.rev180216.Context1.class, connCtx())
                    .build();
    ...
    private org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.Context1 context() {
        return new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.Context1Builder()
                .setTopology(Arrays.asList(systemTopo(), extTopo()))
                .build();
    }

    private org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.connectivity.rev180216.Context1 connCtx() {
        return new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.connectivity.rev180216.Context1Builder()
                .build();
    }
