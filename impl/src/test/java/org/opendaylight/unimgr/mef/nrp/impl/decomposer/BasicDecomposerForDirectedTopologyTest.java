...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.ForwardingDirection;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.OperationalState;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.PortDirection;
...
public class BasicDecomposerForDirectedTopologyTest extends AbstractTestWithTopo {
    ...
    public void twoNodesTestDirection() throws FailureResult, OperationFailedException {
        ...
        l(tx, "n1:1", "n2:1", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
    ...
    private  void threeNodesTopo() {
        ...
        l(tx, "n1:3", "n2:1", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        l(tx, "n2:2", "n3:1", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        try {
            tx.submit().checkedGet();
    ...
    private  void fourNodesTopo() {
        ...
        l(tx, "n1:5", "n2:5", OperationalState.ENABLED, ForwardingDirection.UNIDIRECTIONAL);
        l(tx, "n1:4", "n4:4", OperationalState.ENABLED, ForwardingDirection.UNIDIRECTIONAL);
        l(tx, "n2:3", "n4:3", OperationalState.ENABLED, ForwardingDirection.UNIDIRECTIONAL);
        l(tx, "n3:4", "n2:4", OperationalState.ENABLED, ForwardingDirection.UNIDIRECTIONAL);
        l(tx, "n4:5", "n3:5", OperationalState.ENABLED, ForwardingDirection.UNIDIRECTIONAL);
        try {
            tx.submit().checkedGet();
        } catch (TransactionCommitFailedException e) {
            e.printStackTrace();
    ...
    private  void fiveNodesTopo() {
        ...
        l(tx, "n2:3", "n3:4", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        l(tx, "n3:1", "n1:1", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        l(tx, "n3:3", "n5:1", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        l(tx, "n4:1", "n1:3", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        l(tx, "n1:4", "n2:4", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        l(tx, "n5:4", "n4:2", OperationalState.ENABLED, ForwardingDirection.BIDIRECTIONAL);
        try {
            tx.submit().checkedGet();
        } catch (TransactionCommitFailedException e) {
            e.printStackTrace();
