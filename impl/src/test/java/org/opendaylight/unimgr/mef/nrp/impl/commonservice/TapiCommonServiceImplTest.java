...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.GetServiceInterfacePointDetailsInput;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.GetServiceInterfacePointDetailsInputBuilder;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.GetServiceInterfacePointDetailsOutput;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.GetServiceInterfacePointListOutput;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.get.service._interface.point.list.output.Sip;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.GetTopologyListOutput;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev180216.get.topology.list.output.Topology;
...
public class TapiCommonServiceImplTest extends AbstractTestWithTopo {
    ...
    public void getServiceInterfacePointDetails() throws Exception {
        ...
        org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev180216.get.service._interface.point.details.output.Sip sip = output.getResult().getSip();
